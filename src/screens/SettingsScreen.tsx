...
type SettingsRouteName = keyof Omit<
...
const searchableSettings: Array<{
...

  {
    ...
    icon: "format-size",
    route: "FontSize",
    parent: "Font size & style",
  },

  {
    title: "Disable all notifications",
    icon: "notifications-off",
    route: "DisableNotifications",
    parent: "Notifications",
  },

  {
    title: "Notifications categories",
    icon: "checklist",
    route: "NotificationCategories",
    parent: "Notifications",
  },

  {
    ...
    icon: "volume-up",
    route: "SoundVibration",
    parent: "Notifications",
  },

  {
    title: "Storage used space",
    icon: "storage",
    route: "StorageSync",
    parent: "Storage & sync",
  },
