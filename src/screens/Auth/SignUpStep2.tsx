...
// Replaced 'any' with the 'Props' type defined above
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.btnGroup}>
          <TouchableOpacity 
            style={[styles.btn, role === "student" && styles.btnActive]} 
          ...
          <TouchableOpacity 
            style={[styles.btn, role === "teacher" && styles.btnActive]} 
          ...
          <TouchableOpacity 
            style={[styles.btn, role === "independent" && styles.btnActive]} 
        ...
        {/* Pass combined params to the next step */}
        <TouchableOpacity 
          style={[styles.btn, styles.btnPrimary, !role && styles.btnDisabled]} 
          onPress={() => navigation.navigate("SignUpStep3", { ...route.params, role })} 
          disabled={!role}
        >
...
const styles = StyleSheet.create({
  ...
  btnPrimary: { backgroundColor: "#3b82f6", borderWidth: 0, marginTop: 10 },
