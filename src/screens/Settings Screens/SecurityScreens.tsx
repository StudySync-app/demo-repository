...
const items = [
  { title: "Two-factor authentication", subtitle: "Configure second login step preferences.", icon: "verified-user", route: "TwoFactor" },
  { title: "Change password", subtitle: "Update your Supabase account password.", icon: "lock", route: "ChangePassword" },
  { title: "Recovery phone", subtitle: "Save a local recovery phone preference.", icon: "phone", route: "RecoveryPhone" },
  { title: "Recovery email", subtitle: "View your account recovery email.", icon: "email", route: "RecoveryEmail" },
];
